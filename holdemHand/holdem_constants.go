...
const (
	...
	SECOND_CARD_MASK              uint = 0x0000F000
	...
	HANDTYPE_VALUE_STRAIGHTFLUSH       = uint(StraightFlush) << HANDTYPE_SHIFT
	HANDTYPE_VALUE_STRAIGHT            = uint(Straight) << HANDTYPE_SHIFT
	HANDTYPE_VALUE_FLUSH               = uint(Flush) << HANDTYPE_SHIFT
	HANDTYPE_VALUE_FULLHOUSE           = uint(FullHouse) << HANDTYPE_SHIFT
	HANDTYPE_VALUE_FOUR_OF_A_KIND      = uint(FourOfAKind) << HANDTYPE_SHIFT
	HANDTYPE_VALUE_TRIPS               = uint(Trips) << HANDTYPE_SHIFT
	HANDTYPE_VALUE_TWOPAIR             = uint(TwoPair) << HANDTYPE_SHIFT
	HANDTYPE_VALUE_HIGHCARD            = uint(HighCard) << HANDTYPE_SHIFT
	HANDTYPE_VALUE_PAIR                = uint(Pair) << HANDTYPE_SHIFT
)
...
var TwoCardMaskTableSize = len(TwoCardMaskTable)
